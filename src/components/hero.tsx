...
export const Hero = () => (
  <section className="relative w-full h-screen mx-auto">
    <div className={`absolute inset-0 top-[90px] z-10 sm:pointer-events-none pointer-events-auto max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
